          ...
          <div>
            ...
            <ul className="text-sm">
              <li>
                ...
                <a href="mailto:info@kokebetsibah.edu.et" className="hover:text-blue-500">
                  info@kokebetsibah.edu.et
                </a>
              </li>
              <li>
                <i className="fas fa-phone text-blue-500"></i>{' '}
                <a href="tel:+251123456789" className="hover:text-blue-500">
                  +251 123 456 789
                </a>
              </li>
              <li>
                <i className="fas fa-map-marker-alt text-blue-500"></i> Addis Ababa, Ethiopia
              </li>
            </ul>
          </div>
          <div>
